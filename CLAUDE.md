# Omnia Khaled — Portfolio Data Source

This file is the **single source of truth** for all portfolio content. When updating the portfolio, edit this file and then update `src/data.ts` to match.
...
### Ejada | Al Rajhi Capital — Frontend Developer (React.js) | Aug 2024 – Present
...
### Huawei Technologies — Software Engineer | Sep 2022 – Jul 2024
Huawei is a global leader in ICT infrastructure and smart devices.

**NOC Web Applications (React.js)**
...
### QLAB — Islamic Educational Platform
...
### ESTKDAM — Recruitment Platform (Saudi Arabia)
...
- **Period:** 2018 – 2022
- **Graduation Project:** Shoppingo (Smart Shopping Cart) — Embedded system connected with an administrator website, Flutter mobile app, and data mining techniques.
- **Grade:** Awarded Excellence with a score of 98%.

## Skills

### Frontend Development
JavaScript (ES6+), TypeScript, HTML5, CSS3, JSX
...
### State Management
Redux, RTK Query, React Query, Zustand

### Testing
Cypress (E2E), React Testing Library, Unit & Integration Testing

### Tools & Cloud
Git, GitHub, Postman, Microsoft Azure, Azure Artifacts

### Backend Basics
Node.js, MySQL, REST APIs

### CS Fundamentals
Data Structures, OOP, UML Diagrams

## Certificates
- Intel Ideation Workshop — Intel (2019)
- Potential Startup Course and Training — InnovEgypt University (2019)
- Fundamentals of Community Organizing — Road2Lead (2021)
- IEEE FSB Secretary Participation Certificate — IEEE SSR Egypt (2021)
- Entrepreneurship Program — IEEE VEP (2022)

## Volunteering & Leadership
- Entrepreneurship Member, VEP Program, IEEE Young Professionals (2021 – 2022)
- Secretary (High Board), IEEE Fayoum Student Branch (2020 – 2021)
- Head of Project Management, IEEE Fayoum Student Branch (2019 – 2020)
- Project Management Member, IEEE Fayoum Student Branch (2018 – 2019)
...
- Single-page app with smooth scrolling and dark/light mode
- All content sourced from `src/data.ts`
